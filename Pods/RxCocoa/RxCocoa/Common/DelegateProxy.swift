...
open class DelegateProxy : _RXDelegateProxy {
    ...
    fileprivate var sentMessageForSelector = [Selector: MessageDispatcher]()
    fileprivate var methodInvokedForSelector = [Selector: MessageDispatcher]()

    /// Parent object associated with delegate proxy.
    weak fileprivate(set) var parentObject: AnyObject?
    ...
    */
    ...
    fileprivate func hasObservers(selector: Selector) -> Bool {
...
fileprivate final class MessageDispatcher {
    fileprivate let dispatcher: PublishSubject<[Any]>
    fileprivate let result: Observable<[Any]>
