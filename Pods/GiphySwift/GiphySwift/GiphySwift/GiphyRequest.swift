...
extension GiphyRequest {
    public enum Gif: GiphyRequestable {
        ...
        static fileprivate var urlPrefix = "/gifs"
        ...
        public enum Search: GiphyRequestable {
            ...
            static fileprivate var urlPrefix = Gif.urlPrefix
            var urlComponents: String {
        ...
        public enum Translate: GiphyRequestable {
            ...
            static fileprivate var urlPrefix = Gif.urlPrefix + "/translate"
            var urlComponents: String {
...
extension GiphyRequest {
    public enum Sticker: GiphyRequestable {
        ...
        static fileprivate var urlPrefix = "/stickers"
        var urlComponents: String {
        ...
        public enum Search: GiphyRequestable {
            ...
            static fileprivate var urlPrefix = Sticker.urlPrefix
            var urlComponents: String {
                let url = Search.urlPrefix
        ...
        public enum Translate: GiphyRequestable {
            ...
            static fileprivate var urlPrefix = Sticker.urlPrefix + "/translate"
            var urlComponents: String {
                let url = Translate.urlPrefix
        ...
        public enum Random: GiphyRequestable {
            ...
            static fileprivate var urlPrefix = Sticker.urlPrefix + "/random"
            var urlComponents: String {
